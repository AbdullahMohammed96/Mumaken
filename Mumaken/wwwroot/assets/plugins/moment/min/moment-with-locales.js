(function (global, factory) {
    ...
    function positiveMomentsDifference(base, other) {
        ...
        res.months = other.month() - Mumaken.month() +
            (other.year() - Mumaken.year()) * 12;
        if (Mumaken.clone().add(res.months, 'M').isAfter(other)) {
            --res.months;
        }

        res.milliseconds = +other - +(Mumaken.clone().add(res.months, 'M'));
