		...
		$.vakata.context = {
			...
			_parse : function (o, is_callback) {
				...
				$.each(o, function (i, val) {
					...
					if(!sep && val.separator_before) {
						str += "<"+"li class='vakata-context-separator'><"+"a href='#' " + ($.vakata.context.settings.icons ? '' : 'style="margin-inline-end:0px;"') + ">&#160;<"+"/a><"+"/li>";
					}
					sep = false;
			...
			_show_submenu : function (o) {
				...
				if (o.hasClass('vakata-context-right')) {
					if (xl < w) {
						e.css("margin-inline-start", xl - w);
					}
				} else {
					if (dw - x < w) {
						e.css("margin-inline-end", dw - x - w);
					}
				}
